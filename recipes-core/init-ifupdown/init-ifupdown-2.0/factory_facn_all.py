...
while (time.time() - start) < 100.0:
   ...
   print("f1t2 {} rpm".format(f1t2_count - f1t2_last_count))
   f1t2_last_count = f1t2_count
   print("f2t1 {} rpm".format(f2t1_count - f2t1_last_count))
   f2t1_last_count = f2t1_count
   print("f2t2 {} rpm".format(f2t2_count - f2t2_last_count))
   f2t2_last_count = f2t2_count
   time.sleep(1.0)
